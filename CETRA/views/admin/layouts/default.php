    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarColor03">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link <?php echo LinkHelper::isActive($_SERVER, $router->url('admin_home')) ? "active" : "" ?>" href="<?= $router->url('admin_home') ?>">Tableau de bord</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo LinkHelper::isActive($_SERVER, $router->url('admin_post_index')) ? "active" : "" ?>" href="<?= $router->url('admin_post_index') ?>">Articles</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo LinkHelper::isActive($_SERVER, $router->url('admin_category_index')) ? "active" : "" ?>" href="<?= $router->url('admin_category_index') ?>">Catégories</a>
                </li>
                <li class="nav-item">
